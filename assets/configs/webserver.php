...
return [
    ...
    'apache2' => [
         ...
         */
        'generator' => \Hyperf\MultiTenant\Generators\Webserver\Vhost\ApacheGenerator::class,
    ...
    'nginx' => [
         ...
         */
        'generator' => \Hyperf\MultiTenant\Generators\Webserver\Vhost\NginxGenerator::class,
