...
return [
    ...
    'models' => [
        ...
        // Must implement \Hyperf\MultiTenant\Contracts\Hostname
        'hostname' => \Hyperf\MultiTenant\Models\Hostname::class,

        // Must implement \Hyperf\MultiTenant\Contracts\Website
        'website' => \Hyperf\MultiTenant\Models\Website::class
    ],
    /**
    ...
    'middleware' => [
        ...
        \Hyperf\MultiTenant\Middleware\EagerIdentification::class,

        // The hostname actions middleware (redirects, https, maintenance).
        \Hyperf\MultiTenant\Middleware\HostnameActions::class,
    ],
    'website' => [
        /**
         ...
         */
        'random-id-generator' => Hyperf\MultiTenant\Generators\Uuid\ShaGenerator::class,
    ...
    'db' => [
         ...
         */
        'password-generator' => Hyperf\MultiTenant\Generators\Database\DefaultPasswordGenerator::class,
